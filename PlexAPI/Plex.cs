...
namespace PlexAPI
{
    ...
    public interface IPlex
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetResourcesResponse> GetResourcesAsync(string? xPlexClientIdentifier = null, IncludeHttps? includeHttps = null, IncludeRelay? includeRelay = null, IncludeIPv6? includeIPv6 = null, string? serverUrl = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetUserDetailsResponse> GetUserDetailsAsync(string? serverUrl = null);
    }
    ...
    public class Plex: IPlex
    {
        ...
        /// <summary>
        /// List of server URLs available for the getResources operation.
        /// </summary>
        public static readonly string[] GetResourcesServerList = {
            "https://plex.tv/api/v2",
        };
        /// <summary>
        ...
        public Plex(ISpeakeasyHttpClient client, Func<PlexAPI.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GetCompanionsDataResponse> GetCompanionsDataAsync(string? serverUrl = null)
        {
            ...
            else if(responseStatusCode == 401)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetCompanionsDataResponseBody>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<GetUserFriendsResponse> GetUserFriendsAsync(string? serverUrl = null)
        {
            ...
            else if(responseStatusCode == 401)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetUserFriendsResponseBody>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    obj!.RawResponse = httpResponse;
                    throw obj!;
                }
                else
        ...
        public async Task<GetGeoDataResponse> GetGeoDataAsync(string? serverUrl = null)
        {
            ...
            else if(responseStatusCode == 401)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetGeoDataResponseBody>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    obj!.RawResponse = httpResponse;
                    throw obj!;
                }
                else
        ...
        public async Task<GetResourcesResponse> GetResourcesAsync(string? xPlexClientIdentifier = null, IncludeHttps? includeHttps = null, IncludeRelay? includeRelay = null, IncludeIPv6? includeIPv6 = null, string? serverUrl = null)
        {
            ...
            string baseUrl = Utilities.TemplateUrl(GetResourcesServerList[0], new Dictionary<string, string>(){
            });
            if (serverUrl != null)
            {
                baseUrl = serverUrl;
            ...
            var hookCtx = new HookContext("getResources", null, null);
            ...
            else if(responseStatusCode == 401)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetResourcesResponseBody>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    obj!.RawResponse = httpResponse;
                    throw obj!;
                }
                else
        ...
        public async Task<GetPinResponse> GetPinAsync(string xPlexProduct, bool? strong = null, string? xPlexClientIdentifier = null, string? serverUrl = null)
        {
            ...
            else if(responseStatusCode == 400)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetPinResponseBody>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    obj!.RawResponse = httpResponse;
                    throw obj!;
                }
                else
        ...
        public async Task<GetUserDetailsResponse> GetUserDetailsAsync(string? serverUrl = null)
        {
