...
| ------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- |
| `AccountID`                                       | *long*                                            | :heavy_minus_sign:                                | The account id of this playback                   |
| `DeviceID`                                        | *long*                                            | :heavy_minus_sign:                                | The device id which played the item               |
...
| `ViewedAt`                                        | *long*                                            | :heavy_minus_sign:                                | The time when the item was played                 |